...
import { ShippingAddressCard, OrderCard } from "@components/account"
    ...
    return (
        <Container>
            ...
            {/* <div className='flex items-center justify-between px-8 py-4'>
                <Link href={"/account/user/address-create"}>
                    <a className={`px-3 py-1 textp-center bg-gradient-to-tl to-red-500 from-pink-400 rounded-md`}>
                        <div className='flex items-center text-center w-full justify-between'>
                            <p className='text-white text-sm font-bold'>配送住所</p>
                ...
                <button className={`px-3 py-1 textp-center bg-gradient-to-tl to-red-500 from-pink-400 rounded-md`} onClick={logout} disabled={isLoading}>
                    <div className='flex items-center text-center w-full justify-between'>
                ...
                <div className="py-12">
                    <p className='font-bold mb-3'>アカウント詳細</p>
                    {
                        defaultAddress ? <div className='text-gray-500 text-sm'>
                                            ...
                                            <Link href={{ pathname: "/account/user/address-update", query: defaultAddress }}>
                                                <a>
                                        ...
                                        </div>: <div className='h-20 text-gray-500'>配送情報はありません</div>
                    }
                </div>
            </div>
        </Container>
